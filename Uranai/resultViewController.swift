...
class resultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var personlist = ["スティーブ・ジョブズ","孫正義","イーロン・マスク","ウォルト・ディズニー","柳井正","アルベルト・アインシュタイン","ウォーレン・バフェット","ラリー・エリソン","松下幸之助","ロックフェラー","二コラ・テスラ","ラリー・ペイジ","稲盛和夫","マイケル・ジャクソン","ジェフ・ベゾス","ジャック・マー","マーク・ザッカーバーグ","リチャード・ブランソン","アマンシオ・オルテガ","アンドリュー・カーネギー","ヘンリー・フォード","コーネリアス・ヴァンダー・ビルト","三木谷浩史","トーマス・エジソン","山中伸弥"]
        ...
        var personPhotolist = ["jobu.jpeg","son.jpeg","elon.jpeg","disney.png","yunikuro.jpg","ain.jpeg","bafetto.jpeg","oracl.jpg","matsusita.jpeg","John_D._Rockefeller_1885.jpg","nikoratesura.jpg","rally.jpeg","inamori.jpeg","jackson.jpeg","amazon.jpeg","aribaba.jpeg","facebook.jpeg","Branson.jpg","zara.jpg","carnegie.jpeg","ford.jpeg","bilt.jpeg","mikitani.jpeg","ejison.jpg","charls cork.jpg"]
