...
class resultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var personlist = ["スティーブ・ジョブズ","孫正義","イーロン・マスク","ウォルト・ディズニー","柳井正","アルベルト・アインシュタイン","ウォーレン・バフェット","ラリー・エリソン","松下幸之助","ロックフェラー","二コラ・テスラ","ラリー・ペイジ","稲盛和夫","マイケル・ジャクソン","ジェフ・ベゾス","ジャック・マー","マーク・ザッカーバーグ","リチャード・ブランソン","アマンシオ・オルテガ"]
        var personDetaillist = ["○アップル創業者　　　1976年最初のApple Iを販売を皮切りにiPhone、iPodなど多くの製品を世に生み出す。後に新会社ピクサーを創設。映画トイストーリーを爆発的人気に。誰もが認める世界一の経営者。","孫正義説明","イーロンマスク説明","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p",]
        var personPhotolist = ["jobu.jpeg","son.jpeg","elon.jpeg","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p"]
